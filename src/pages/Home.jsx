...
export default function Home() {
  ...
  <div>
      ...
      <section id="about" className="container d-flex align-items-center text-center my-5 justify-content-center gap-5">
        <img src="./src/assets/1980.jpeg" alt="Moamel Hashim" className="rounded-circle mb-3" width="200" />
        <div className="">
        <p className="lead">Hello, I'm</p>
        <h1 className="display-4">Moamel Hashim</h1>
        <p className="fs-4 text-muted">Web developer</p>
        <div className="d-flex gap-3 justify-content-center">
          <a className="btn btn-outline-secondary" href="./assets/resume.pdf" target="_blank">Download CV</a>
      ...
      <div className="row align-items-center mt-5 justify-content-center">
        <div className="col-md-5 w-25 h-25">
          <img src="./src/assets/1994.jpeg" alt="About Me" className="img-fluid rounded" />
        </div>
          ...
          <div className="row mb-4">
            ...
            <div className="col-md-6">
              <div className="border rounded p-3 text-center h-100">
                ...
                <p className="mb-0">B.Sc. Bachelors Degree</p>
                <p className="text-muted">M.Sc. Masters Degree</p>
              </div>
            </div>
          </div>
    ...
    <ContactMe/>
      ...
      <footer className="bg-light text-center py-4">
        <div>
          ...
          <p className="text-muted mb-0">&copy; 2023 John Doe. All Rights Reserved.</p>
        </div>
      </footer>
    </div>
  );
